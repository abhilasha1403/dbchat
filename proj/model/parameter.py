...
class ModelControllerParameters(BaseParameters):
    ...
    log_file: Optional[str] = field(
        default="proj_model_controller.log",
        metadata={
            "help": "The filename to store log",
        },
    )
    tracer_file: Optional[str] = field(
        default="proj_model_controller_tracer.jsonl",
        metadata={
...
class ModelAPIServerParameters(BaseParameters):
    ...
    log_file: Optional[str] = field(
        default="proj_model_apiserver.log",
        metadata={
            "help": "The filename to store log",
        },
    )
    tracer_file: Optional[str] = field(
        default="proj_model_apiserver_tracer.jsonl",
        metadata={
            "help": "The filename to store tracer span records",
        },
    )
...
class ModelWorkerParameters(BaseModelParameters):
    ...
    worker_class: Optional[str] = field(
        default=None,
        metadata={"help": "Model worker class, proj.model.cluster.DefaultModelWorker"},
    )
    ...
    log_file: Optional[str] = field(
        default="proj_model_worker_manager.log",
        metadata={
            "help": "The filename to store log",
        },
    )
    tracer_file: Optional[str] = field(
        default="proj_model_worker_manager_tracer.jsonl",
        metadata={
            "help": "The filename to store tracer span records",
        },
    )
...
class ProxyModelParameters(BaseModelParameters):
    ...
    llm_client_class: Optional[str] = field(
        ...
        metadata={
            ...
            "proj.model.proxy.llms.proxy_model.ProxyModel"
        },
    )
