...
def test_md_header_text_splitter() -> None:
    ...
    expected_output = [
        Chunk(
            content="{'Header 1': 'proj', 'Header 2': 'description'}, my name is proj",
            metadata={"Header 1": "proj", "Header 2": "description"},
        ),
        Chunk(
            content="{'Header 1': 'proj', 'Header 2': 'content'}, my name is aries",
            metadata={"Header 1": "proj", "Header 2": "content"},
        ),
    ]
