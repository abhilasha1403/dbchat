...
class ComponentType(str, Enum):
    WORKER_MANAGER = "proj_worker_manager"
    WORKER_MANAGER_FACTORY = "proj_worker_manager_factory"
    MODEL_CONTROLLER = "proj_model_controller"
    MODEL_REGISTRY = "proj_model_registry"
    MODEL_API_SERVER = "proj_model_api_server"
    MODEL_CACHE_MANAGER = "proj_model_cache_manager"
    AGENT_HUB = "proj_agent_hub"
    MULTI_AGENTS = "proj_multi_agents"
    EXECUTOR_DEFAULT = "proj_thread_pool_default"
    TRACER = "proj_tracer"
    TRACER_SPAN_STORAGE = "proj_tracer_span_storage"
    RAG_GRAPH_DEFAULT = "proj_rag_engine_default"
    AWEL_TRIGGER_MANAGER = "proj_awel_trigger_manager"
    AWEL_DAG_MANAGER = "proj_awel_dag_manager"
    UNIFIED_METADATA_DB_MANAGER_FACTORY = "proj_unified_metadata_db_manager_factory"
