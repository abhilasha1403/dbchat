...
class BufferedConversationMapperOperator(ConversationMapperOperator):
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from proj.core.interface.message import AIMessage, HumanMessage
            from proj.core.operators import BufferedConversationMapperOperator
    ...
    def _filter_round_messages(
        ...
        Examples:
            >>> from proj.core import AIMessage, HumanMessage
            >>> from proj.core.operators import BufferedConversationMapperOperator
            >>> messages = [
            ...     [
            ...         HumanMessage(content="Hi", round_index=1),
